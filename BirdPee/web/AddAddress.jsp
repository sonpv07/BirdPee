<%-- 
    Document   : AddAddress
    Created on : Jul 5, 2023, 10:59:49 PM
    Author     : Admin
--%>
        ...
        <main>
            <div class="main-container">
                ...
                <div class="main-right-container">
                    <div class="add-address-title">Add New Receiver Address</div>
                    <div class="main-right-container-inner">
                        <form class="add-address-container" action="BirdPee" method="post">
                            ...
                            <div class="add-address-left">
                                <div class="input">
                                    <div>Full Name</div>
                                    <input type="text" name="name" placeholder="Please enter your receiver's name" id="name" oninput="keepData()" value="<%= (name.equalsIgnoreCase("") ? "" : name)%>">
                                </div>
                                <div class="input">
                                    <div>Phone Number</div>
                                    <input type="text" name="phone" placeholder="Please enter your receiver's phone number" id="phone" oninput="keepData()" value="<%= (phone.equalsIgnoreCase("") ? "" : phone)%>">
                                </div>
                            </div>
                            <div class="add-address-right">
                                <div class="input">
                                    <div>Address</div>
                                    <input type="text" name="address" placeholder="Please enter your address" id="address" oninput="keepData()" value="<%= (address.equalsIgnoreCase("") ? "" : address)%>">
                                </div>
                                <div class="input-district" >
                                    <div class="input-title">
                                        <p><%= request.getParameter("provinceid") != null ? BirdPeeDAO.SHIP_getProvinceNameByID(request.getParameter("provinceid")) : "Province"%></p>
                                    ...
                                    <ul class="options">
                                        ...
                                        %>
                                        <li>
                                            <a href="AddAddress.jsp?provinceid=<%= p.split("@")[1]%>"> <%= p.split("@")[0]%> </a>
                                        </li>
                                        <%
                                            }
                                        %>
