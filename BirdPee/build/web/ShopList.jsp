<%-- 
    Document   : ShopList
    Created on : May 31, 2023, 11:26:45 PM
    Author     : Admin
--%>
                ...
                <div class="main__container_sort">
                    ...
                    <div class="sort-option">
                        <p style="font-size: 20px; font-weight: bold">
                            <%= (((String) session.getAttribute("shopSort")) != null) ? (String) session.getAttribute("shopSort") : "Newest"%>
                            <%
                                String sort = (String) session.getAttribute("shopSort");
                                if (sort == null) {
                                    sort = "Newest";
                                }
                                session.removeAttribute("shopSort");
                            %>
                            <i class="fas fa-solid fa-sort-down"></i>
                        </p>
                        <ul class="options">
                            <li>
                                <a href="BirdPee?action=SSort&sort=Newest">Newest</a>
                            </li>
                            <li>
                                <a href="BirdPee?action=SSort&sort=alphabetup">A to Z</a>
                            </li>
                            <li>
                                <a href="BirdPee?action=SSort&sort=alphabetdown">Z to A</a>
                            </li>
                            <li>
                                <a href="BirdPee?action=SSort&sort=Popular">Popular</a>
                            </li>
                            <li>
                                <a href="BirdPee?action=SSort&sort=Rating">Rating</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <%
                    ArrayList<Shop> listS = BirdPeeDAO.SHOP_getAllShopAfterSorted(sort);
                    if (listS != null) {
                        for (Shop s : listS) {
                    ...
                    <div class="column">
                        <div class="item">
                            ...
                            <div class="shop-right">
                                ...
                                <div class="product-section">
                                    <div><i class="fa-solid fa-crow"></i><%= BirdPeeDAO.SHOP_countNumberOfProduct(s.getId())%></div>
                                    <p>Product</p>
                                </div>

                                <div class="product-section">
                                    <div><i class="fa-solid fa-message"></i> <%= BirdPeeDAO.SHOP_countNumberOfFeedback(s.getId())%></div>
                                    <p>Feedback</p>
                                </div>

                                <div class="product-section">
                                    <div>
                                        <i class="fa-solid fa-star" style="color: #ffd43b"></i> <%= BirdPeeDAO.SHOPOWNER_getRating(s.getId()) %></div>
                                    <p>Rating</p>
                                </div>
